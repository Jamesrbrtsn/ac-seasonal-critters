        ...
        <h2 className="sc-h2">About</h2>
            ...
            <div id="sc-right-input">
                <div>
                    ...
                    <div id="sc-ex-grid">
                        <ExampleCard type ="fish"
                            picturePath="https://vignette.wikia.nocookie.net/animalcrossing/images/a/a0/NH-Icon-saddledbichir.png"/>
                        <ExampleCard type ="bug"
                            picturePath="https://vignette.wikia.nocookie.net/animalcrossing/images/5/5b/NH-Icon-goliathbeetle.png"/> 
                    </div> 
                </div>
            </div>
    </div>
